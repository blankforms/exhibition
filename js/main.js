...
[].forEach.call(document.getElementsByClassName('modal-enabled'), (el) =>  {
    el.onclick = function(){
        ...
        scrollConverter.deactivate(function (offset) {
...
function sendMail() {
    var link = "mailto:wyatt.c.gormley@gmail.com"
             ...
             + "&body=" + escape(document.getElementById('inquiry-mail').textContent) + escape("\n") + escape(document.getElementById('return-address').value)
    ;
